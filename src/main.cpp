...
namespace Configuration
{
	...
	namespace WorldCreation
	{
		...
		std::map<std::string, Model> load_models() noexcept
		{
			...
			models.insert({"pedestal", Model("pedestal", "resources/pedestal/10421_square_pedastal_iterations-2.obj", {0.0f, 0.0f, -30.0f}, glm::quat({0.5f, 0.0f, 0.0f}), {0.1f, 0.1f, 0.1f})});
